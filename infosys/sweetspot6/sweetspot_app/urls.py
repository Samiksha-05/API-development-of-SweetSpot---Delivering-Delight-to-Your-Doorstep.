...
from .views import CustomerViewSet, PaymentView, UserStoreViewSet, CakeViewSet, CakeCustomizationViewSet, CartViewSet, OrderViewSet , AddCakeToCartViewSet,AdminCustomerViewSet, AdminCakeViewSet, AdminCakeCustomizationViewSet, AdminOrderViewSet, AdminStoreViewSet
...
router.register(r'stores', UserStoreViewSet, basename='user-store')
